    ...
    async def on_message_edit(self, _before: discord.Message, after: discord.Message):
        ...
        with LogContextManager(user_id=user_id, fixture_id=fixture["id"], source="thread"):
            ...
            if errors:
                ...
                log_event(
                    logger,
                    event_type="prediction.edit_parse_failed",
                    message="Invalid prediction format in edit",
                    user_id=user_id,
                    fixture_id=fixture["id"],
                    source="thread",
                    errors_count=len(errors),
            ...
            try:
                ...
                log_event(
                    ...
                    message="Thread prediction updated successfully",
                    user_id=user_id,
                    fixture_id=fixture["id"],
                    source="thread",
                    predictions_count=len(predictions),
                ...
                logger.error(
                    f"Error updating thread prediction: {e}",
                    exc_info=True,
                    extra={
                        "event_type": "prediction.update_failed",
                        "user_id": user_id,
                        "fixture_id": fixture["id"],
                        "source": "thread",
                        "error_type": type(e).__name__,
