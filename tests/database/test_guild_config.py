...
class TestGuildConfig:
    ...
    async def test_guild_config_persists_and_updates(self, temp_db_path):
        ...
        assert await db.guild_config.get_guild_config("111111") is None
        ...
        await db.guild_config.upsert_guild_config("111111", "role-2", "channel-2")
        updated = await db.guild_config.get_guild_config("111111")
    ...
    async def test_guild_config_is_per_guild(self, temp_db_path):
        ...
        await db.guild_config.upsert_guild_config("111111", "role-1", "channel-1")
        await db.guild_config.upsert_guild_config("222222", "role-2", "channel-2")

        guild_one = await db.guild_config.get_guild_config("111111")
        guild_two = await db.guild_config.get_guild_config("222222")
